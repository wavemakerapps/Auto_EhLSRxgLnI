...
package com.auto_ehlsrxglni.hrdb.controller;
...
import com.auto_ehlsrxglni.hrdb.Department;
import com.auto_ehlsrxglni.hrdb.Employee;
import com.auto_ehlsrxglni.hrdb.service.DepartmentService;
...
public boolean deleteDepartment(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public String exportDepartmentsAndGetURL(@RequestBody ExportOptions options, @ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
         String fileName = exportedFileManager.create(departmentService.export(options, query, pageable),
                 Department.class.getSimpleName(), options.getExportType().getExtension()).getName();
