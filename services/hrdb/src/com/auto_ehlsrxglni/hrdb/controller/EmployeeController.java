...
import com.auto_ehlsrxglni.hrdb.service.EmployeeService;
...
public boolean deleteEmployee(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public String exportEmployeesAndGetURL(@RequestBody ExportOptions options, @ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
         String fileName = exportedFileManager.create(employeeService.export(options, query, pageable),
                 Employee.class.getSimpleName(), options.getExportType().getExtension()).getName();
