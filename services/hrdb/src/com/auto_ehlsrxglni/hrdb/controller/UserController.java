...
import com.auto_ehlsrxglni.hrdb.User;
import com.auto_ehlsrxglni.hrdb.service.UserService;
...
public boolean deleteUser(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public String exportUsersAndGetURL(@RequestBody ExportOptions options, @ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
         String fileName = exportedFileManager.create(userService.export(options, query, pageable),
                 User.class.getSimpleName(), options.getExportType().getExtension()).getName();
