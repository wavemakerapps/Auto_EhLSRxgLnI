...
import com.auto_ehlsrxglni.hrdb.service.VacationService;
...
public boolean deleteVacation(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public String exportVacationsAndGetURL(@RequestBody ExportOptions options, @ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
         String fileName = exportedFileManager.create(vacationService.export(options, query, pageable),
                 Vacation.class.getSimpleName(), options.getExportType().getExtension()).getName();
